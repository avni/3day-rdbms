...
gsettings set com.canonical.Unity.Launcher favorites "['application://debian-xterm.desktop','application://firefox-iap.desktop','application://phpmyadmin.desktop','application://nautilus.desktop']"
