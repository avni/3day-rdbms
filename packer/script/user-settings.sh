...
gsettings set com.canonical.Unity.Launcher favorites "['application://gnome-terminal.desktop','application://mysql-client-iap.desktop','application://firefox-iap.desktop','application://phpmyadmin.desktop','application://nautilus.desktop','application://emacs24.desktop']"
